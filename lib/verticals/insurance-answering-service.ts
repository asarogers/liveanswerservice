...
export const insuranceConfig: VerticalConfig = {
  ...
  voices: {
    ...
    cards: [
      { name: "Professional Sarah", label: "Warm & friendly", sampleLine: "Hi, this is Sarah at Bay Area Independent Insurance..." },
      { name: "Executive Marcus", label: "Authoritative", sampleLine: "Thank you for calling Bay Area Independent Insurance." },
      { name: "Casual Jamie", label: "Conversational", sampleLine: "Hey, Bay Area Insurance — how can I help?" },
    ],
  },
