  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[60] w-[calc(100vw-2rem)] max-w-2xl bg-[#2C2C2C] rounded-2xl shadow-2xl p-7">
      ...
      <div className="flex items-start gap-4 mb-6 pr-6">
        <svg className="w-11 h-11 shrink-0 text-[#1A1A17] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-base text-gray-200 leading-relaxed">
          ...
          cookies in our{' '}
          <a href="/contact" className="text-[#C4622D] hover:text-[#A34F23] underline">
            Cookie Notice
          </a>
          .
        </p>
