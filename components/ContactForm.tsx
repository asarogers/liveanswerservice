...
export default function ContactForm() {
  ...
  if (status === 'success') {
    return (
      <div
        role="alert"
        className="rounded-xl border border-[#1A1A17] bg-[#F2F0E8] p-8 text-center"
      >
        <div className="mb-3 text-[#1A1A17] text-4xl" aria-hidden="true">
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      ...
      <div>
        ...
        >
          Full Name <span aria-hidden="true" className="text-[#C4622D]">*</span>
      ...
      <div>
        <label
          ...
          className="mb-1.5 block text-sm font-semibold text-[#2C2C2C]"
        >
          Email Address <span aria-hidden="true" className="text-[#C4622D]">*</span>
          <span className="sr-only">(required)</span>
        </label>
        <input
          id="contact-email"
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full resize-y rounded-lg border border-[#E0D8CF] bg-white px-4 py-3 text-[#2C2C2C] placeholder:text-[#5A5A5A]/60 focus:border-[#1A1A17] focus:outline-none focus:ring-2 focus:ring-[#1A1A17]/30 transition-colors"
        />
      </div>
